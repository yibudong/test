    ...
    <div class="sales-board-form">
      <div class="sales-board-line">
        ...
        <div class="sales-board-line-right">
          <v-counter :max="max" :min="min"  @on-change="getMessage('number',$event)"></v-counter>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">行业：</div>
        <div class="sales-board-line-right">
          <v-selection :selections="industry" @on-change="getMessage('ind',$event)"></v-selection>
        </div>
      </div>
      <div class="sales-board-line">
        <div class="sales-board-line-left">产品版本</div>
        <div class="sales-board-line-right">
          <v-mul-chooser :selections="productList" @on-change="getMessage('pro',$event)"></v-mul-chooser>
        </div>
      </div>
      <div class="sales-board-line">
